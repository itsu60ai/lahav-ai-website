...
export const ABOUT_DEFAULT: AboutContent = {
  ...
  partners: {
    yehiel: {
      ...
      bio: 'יחיאל מוביל את השיווק, המכירות וקשרי הלקוחות. הוא נמצא בחזית מול העסק, מבין את הצורך, מחדד את הבעיה ודואג שהפתרון שאנחנו בונים באמת מתחבר למה שהלקוח צריך.',
    },
    ethan: {
      role: 'שותף',
      focus: 'תפעול, מערכות וטכנולוגיה',
      bio: 'איתן מוביל את הצד התפעולי והטכנולוגי של LAHAV AI. הוא אחראי על אפיון, תכנון ובנייה של מערכות ותהליכים, ועל החיבור בין הצורך העסקי לפתרון שעובד בפועל.',
    },
  },
  seo: seoDefault(
    'אודות | LAHAV AI',
